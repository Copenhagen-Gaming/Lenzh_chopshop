...
function ChopVehicle()
    ...
    elseif GetGameTimer() - Timer > Config.CooldownMinutes * 60000 then
        ...
        if TotalTime >= 0 then
            ...
            TriggerEvent('renzu_notify:Notify','error','Chop Shop', 'The Fuzz Has Been Around, See You Later', progressbar)
        ...
        if vehicle then
            ...
            ESX.TriggerServerCallback('Lenzh_chopshop:OwnedCar', function(owner)
                if owner then
                    ...
                    TriggerEvent('renzu_notify:Notify','success','Chop Shop', 'I Wont Tell You Chopped That Vehicle!', option)
                    DeleteVehicle(vehicle)
                else
                    --ESX.ShowNotification("Vehicle Chopped Successfully...", false, true, g)
                    TriggerEvent('renzu_notify:Notify','success','Chop Shop', 'Get Your Items And Get Out!', option)
                    DeleteVehicle(vehicle)
                end
            end, vehPlate)
        end
